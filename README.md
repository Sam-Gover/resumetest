...
| # | Способность | Навык | Клавиша |
|---|-------------|-------|---------|
| 1 | 🔍 Сканер требований | Бизнес-анализ | 1 |
| 2 | 🤖 AI-Ассистент | Generative AI | 2 |
| 3 | 🌐 API-Портал | REST API | 3 |
| 4 | ⚙️ Системный инсталлятор | Внедрение систем | 4 |
| 5 | 🚀 Запуск проекта | Project Management | 5 |
| 6 | 🐛 Режим отладки | Тестирование | 6 |
| 7 | 📄 Автоматизация | Документооборот | 7 |
